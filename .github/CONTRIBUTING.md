...
When you start on a new feature, it's worth a quick look at **`https://github.com/Gordin/GameHelper2`** (branch `main`) — the C# reference project this codebase originated from. Solutions or pattern-scanning approaches you'll need may already be solved there in a form you can port.
